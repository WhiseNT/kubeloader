...
public class DynamicSwordBuilder extends SwordItemBuilder implements DynamicBuilder {
    public HashMap<String, Tier> enableTierMap = new HashMap<String, Tier>();
    public int baseAttack;
    public float baseAttackSpeed;
    public String baseTier;

    public DynamicSwordBuilder(ResourceLocation i) {
        super(i);
    ...
    public Item createObject() {
        return new DynamicSwordItem(baseAttack,baseAttackSpeed,baseTier,enableTierMap);
    }
}